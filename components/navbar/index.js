...
function Navbar() {
  ...
  const menu = (
    <div className="mobile-menu-items">
      ...
      <Link
        href="/about-us"
        className={router.pathname == "/about-us" ? "active-link" : ""}
      >
        من نحن
      </Link>
      <div className="mobile-register-first">
        <Button onClick={handelRegisterNewUser}> كن أول المستخدمين </Button>
      </div>
      <div className="mobile-soical-links">
        <Link
        ...
        {/* <Link href="https://www.linkedin.com" passHref={true} target="_blank">
          <div className="icon-box">
            <svg
              style={{ color: "#fff" }}
  ...
  return (
    <div className="navbar-container">
      <Row align="middle" style={{ height: "100%" }}>
        ...
        {/* mobile menu */}
        <Col xs={12} sm={12} md={0} lg={0} xl={0} className="dropdown-mobile">
            ...
            <Row align="middle">
              ...
              <Col span={3}>
                <Link
                  href="/about-us"
                  className={
                    router.pathname == "/about-us" ? "active-link" : ""
                  }
                >
                  من نحن
                </Link>
              ...
              <Col span={7}>
                <div className="register-first">
                  <Button onClick={handelRegisterNewUser}>
                    كن أول المستخدمين
                  </Button>
                </div>
              </Col>
              <Col span={3} />
              <Col span={8} className="soical-links-container">
